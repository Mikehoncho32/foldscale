...
final class ActionsTests: XCTestCase {
    ...
    func testAdditionalProtectedRoots() {
        let bundle = URL(fileURLWithPath: "/Applications/Radix.app")
        let inside = bundle.appendingPathComponent("Contents/MacOS/Radix")
    ...
    private func makeTempDir() throws -> URL {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("radix-actions-\(UUID().uuidString)")
