...
final class SmartListEngineTests: XCTestCase {
    ...
    func testProductNameStripsVersionsInMultiWordNames() {
        ...
        XCTAssertEqual(SmartListQuery.productName(from: "Foldscale-v1.0.0.dmg"), "foldscale")
    ...
    func testBigProjectsDetectsRootsAndStats() {
        ...
        XCTAssertEqual(
            names(result, in: tree, group: "Code"), ["foldscale"],
        ...
        let foldscale = result.entries.first { tree.name(of: $0.node) == "foldscale" }!
        XCTAssertEqual(
            foldscale.note, "last touched 20 d ago · 2 GB rebuildable",
